...
msg();
console.log(" ");
console.log(` 2] with 3 args and no retur values ,for received 3 parameters perform the multiplication`);
...
let addchar =addition (" I am" ," learning"," ES6"," Fracture" ," in depth");
